...
class BiRNN:
    def __init__(self, sequence_length, num_classes, vocab_size, embedding_size,
        ...
        with tf.variable_scope("bi-lstm"):
            ...
            _fw_cell = tf.nn.rnn_cell.BasicRNNCell(hidden_size)
            ...
            _bw_cell = tf.nn.rnn_cell.BasicRNNCell(hidden_size)
        ...
        with tf.variable_scope('output'):
            self.logits = tf.layers.dense(self.rnn_outputs, num_classes, kernel_initializer=initializer())
